                    ...
                    <div class="task-data">
                        <div class="task-details">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <select id="select3" name="teams_id[]" class="target" multiple data-name="teams_id" placeholder = "{{__('messages.team_members')}}" >
                                        @php
                                        ...
                                        @if(!empty($users3))
                                            ...
                                            @foreach ($users3 as $key => $user3)
                                                ...
                                                <option id="{{$key}}" value="{{$user3->id}}" name="teams_id[]"
                                                        ...
                                                        @else
                                                            data-left="https://pri-po.com/public/assets/images/default.png"
                                                        @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <select id="select5" name="guests_id[]" class="target" multiple data-name="guests_id" placeholder="{{__('messages.Besucher')}}">
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-7">
                                        <select name="task_category_id" id="task_category_one" data-task-id="{{$task->id}}"
                                                ...
                                                data-name="task_category_id" placeholder="{{__('messages.department')}}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <select name="task_category_id_two"  id="task_category_two" class="custom-select form-control target Fachbereich2"  data-name="task_category_id_two" placeholder="{{__('messages.department')}}">
                            ...
                            <div class="row">
                                    <div class="col-md-2">
                                        <label class="control-label">{{__('messages.under_category')}}</lable>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="row">
                             ...
                             <!-- Upload Post Image -->
                               <div class="form-group mt-3">
                                   <form method="POST" action="{{ route('tasks.upload_post_image') }}" enctype="multipart/form-data">
                                            @csrf
                                                <div class="row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class=" fileContainer" style="margin:0;">
                                                            <input type="file" id="imageUpload-1"   name="image"  class="image-upload"  required>
                                                            <label for="imageUpload-1" class="white-button"><span><i class="far fa-image"></i> Upload Image</span></label>
                                                        </div>
                                                        ...
                                                        >
                                                            <div class="image-preview-hover" >
                                                                <button type="button" class="remove-image-privew" data-id="{{$task->id}}"><i class="fas fa-times"></i></button>
                                                            </div>
                                                        </div>
                                                        <button type="submit" class="btn btn-primary btn-sm upload_post_image"><i class="fa fa-upload"></i> {{__('messages.upload')}}</button>
                                                    </div>
                                                        ...
                                                        @foreach($task->un_completed_subtasks as $subtask)
                                                            <li @if($subtask->subtask_status != 0) class="task  ui-state-default completed"
                                                                ...
                                                                @if(!empty($subtask->added_by->image))
                                                                    <img src="https://pri-po.com/public/assets/images/users/{{$subtask->added_by->image}}" class="subtaskimage"/>
                                                                @else
                                                                    <img src="https://pri-po.com/public/assets/images/users/default.png" class="subtaskimage"/>
                                                                @endif
                                                                ...
                                                                <div class="test">
                                                                    ...
                                                                    <!--New Select Box v2 -->
                                                                    <select class="mySelect2 subtasks_users" style="width: 300px;"  name="TaskResponsiple" data-id="{{$subtask->id}}" >
                                                            ...
                                                            <li @if($subtask->subtask_status != 0) class="task  ui-state-default completed"
                                                                ...
                                                                @if($subtask->subtask_status == 1)
                                                                    <label class="form-checkbox-label">
                                                                        <input name="completed" class="form-checkbox-field  taskched" data-id="{{$subtask->id}}"  type="checkbox" value="1" checked  />
                                                                        <i class="form-checkbox-button"></i>
                                                                    </label>
                                                                @else
                                                                    <label class="form-checkbox-label">
                                                                        <input name="completed" class="form-checkbox-field taskched" data-id="{{$subtask->id}}"  type="checkbox" value="0"  />
                                                                        <i class="form-checkbox-button"></i>
                                                                    </label>
                                                                @endif
                                                                ...
                                                                <select class="slick{{$subtask->id}} task_resp" is="ms-dropdown" data-enable-auto-filter="true"  data-id="{{$subtask->id}}"
                                                                        name="TaskResponsiple" style="height: 30px ; width:89px !important; " data-enable-auto-filter="true">
                                                                    <option data-imagesrc="{{asset('public/assets/images/person.png')}}">Select </option>
                                                                    @foreach($users as $user)
                                                                        <option value="{{$user->id}}"
                                                                                @if(!empty($user2->image))
                                ...
                                <div class="comments">
                                    ...
                                    <div class="row">
                                        <div class="col-md-1 text-center">
                                            <lable class="control-label taglabel"><i class="fa fa-tags"></i></lable>
                                        </div>
                                        <div class="col-md-7">
                                        ...
                                        <!--End Tags-->
                                        <div class="col-md-1">
                                            <button type="button" id="add_comment" class="send-comment send-comment2  btn_1" data-task="{{$task->id}}">
            ...
            "></i>
                                ...
                                <div class="col-md-10">
                                    <div class="comments-header">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <i class="bi bi-chat-left-dots"></i> Kommentare
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input  cb-value2" type="checkbox">
                                                </div>
                                            </div>
                                                ...
                                                <div class="comments-container">
                                                    <ul id="comments-list" class="comments-list{{$comment->id}} comments-list" data-author="{{$comment->comment_added_by}}">
                                                        <li>
                                                            <div class="comment-main-level">
                                                                ...
                                                                <div class="comment-box">
                                                                    <div class="comment-head">
                                                                        ...
                                                                        <span> <?php echo $comment->created_at->format('d.m.Y H:i:s') ?></span>
                                                                                ...
                                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <p><span id="charchtercount{{$comment->id}}">0</span> Buchstaben </p>
                                                                                        </div>
                                                                    ...
                                                                    <div class="comment-content">
                                                                        @if(!empty($comment->comment))
                                                                            ...
                                                                            <a  class="update_btn{{$comment->id}} btn  btn-sm update_comment_btn mr-2" data-id="{{$comment->id}}"> {{__('messages.update_comment')}} </a>
                                                                        ...
                                                                        @if(!empty($comment->subtask))
                                                                            <h6 class="text-primary subtask_details"> <span>
                                                                                        {{   __('messages.subtask')}} :
                                                                                    </span>
                                                                                <a href="javascript:void(0);" class="TaskTitle" data-id="{{ $comment->subtask->id }}">{!!   \Illuminate\Support\Str::limit($comment->subtask->subtask_title, 150, $end='...')  !!}</a>
                                                                            </h6>
                                                                        @endif
                                                            ...
                                                            <div class="add_replay" data-id="{{$comment->id}}">  {{__('messages.replay')}} <i class="bi bi-plus"></i>
                                                            </div>
                                                    ...
                                                    <div class="add_new_replay  add_new_replay{{$comment->id}}">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-11">
                                                                <textarea rows="2" data-id="{{$comment->id}}"  class="replay_comment{{$comment->id}} form-control replaystyle" placeholder="{{__('messages.replay')}}" style="border:1px solid #777 !important;margin-bottom:10px;margin-left: 47px;"></textarea>
                                                            ...
                                                            <div class="col-md-10" style="padding-left:58px">
                                                                <select  id="select{{$comment->id}}" name="tags[]" class="target replay_tags" multiple data-name="tags[]" style="width: 100%; height: 50px !important ;  border:1px solid #777 !important ; margin-left: 23px!important ;  " data-id="{{$comment->id}}" >
                                                                    @php
                                                                        $users_gests = \App\Models\User::where(['deleted' => 0 , 'status' => 0 ] )->get();
                                                                    @endphp
                                                                    @foreach($users_gests as $user)
                                                                        <option id="{{$user->id}}" value="{{$user->id}}"
                                                                                @if(!empty($user->image))
                                                            ...
                                                            <div class="col-md-2">
                                                                <!--End Replay Tags -->
                                                                <button style="height: 100%;width: 100%;margin-left: -20px;" type="button"  class="btn btn-primary send_replay btn_1" data-id="{{$comment->id}}" id="send_replay{{$comment->id}}" disabled >
                                                                    <div class="svg-wrapper" style="margin: 0  auto">
                                    ...
                                    <div class="comments2 completed_comments" style="display: none">
                                        @foreach($task->comments as $comment)
                                            @if($comment->done == 1)
                                                <div class="comments-container">
                                                    <ul id="comments-list" class="comments-list{{$comment->id}} comments-list" data-author="{{$comment->comment_added_by}}">
                                                        <li>
                                                            ...
                                                            <div class="replayes_count{{$comment->id}} replayes_count add_replay" data-id="{{$comment->id}}" data-list="{{$comment->comment_added_by}}"><p><span>{{$comment->replays->count()}}</span> </p> </div>
                                                            <div class="add_replay" data-id="{{$comment->id}}">  {{__('messages.replay')}} <i class="bi bi-plus"></i>
                                                            </div>
                                                    ...
                                                    <div class="add_new_replay  add_new_replay{{$comment->id}}">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-11">
                                                                <textarea style="border:1px solid #777 !important;margin-bottom:10px;margin-left: 47px;" rows="3" class="replay_comment{{$comment->id}} form-control replaystyle" placeholder="{{__('messages.replay')}} "></textarea>
                                                                <div id="commentoutput{{$comment->id}}"></div>
                                                                <!--Replay Tags -->
                                                                <script type="text/javascript">
                                                            ...
                                                            <div class="col-md-10" style="padding-left:58px">
                                                                <select id="select{{$comment->id}}" name="tags[]" class="target replay_tags" multiple data-name="tags[]" style="width: 100%; height: 50px !important; margin-left:23px !important;  " data-id="{{$comment->id}}">
                                                                    @php
                                                                        $users_gests = \App\Models\User::where('deleted' , 0 )->get();
                                                                    @endphp
                                                                    @foreach($users_gests as $user)
                                                                        <option id="{{$user->id}}" value="{{$user->id}}"
                                                                                @if(!empty($user->image))
                                                            ...
                                                            <div class="col-md-2">
                                                                <!--End Replay Tags -->
                                                                <button type="button" style="height: 100%;width: 100%;margin-left: -20px;"  class="btn btn-primary send_replay" data-id="{{$comment->id}}" >
                                                                    <div class="svg-wrapper" style="margin:0 auto ">
                                                                        <i class="fas fa-paper-plane"></i>
                                                                    </div>
                                                                </button>
                    ...
                    <div class="row">
                                    <div class="col-md-5">
                                        <form id="dataup" class="form" method="POST" action="{{route('admin.subtasks.store_comment')}}" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="type" value="image">
                                            <input type="hidden" name="task_id" value="{{$task->id}}">
                                            <label for="custom-file-upload" class="filupp">
                                                <span class="filupp-file-name js-value">1- {{__('messages.choose_photo')}} <i class="fa fa-file"></i>  </span>
                                                <input type="file" name="comment_image" id="custom-file-upload"/>
                                            </label>
                                            <button type="submit"  class="submit_comment"><i class="fa fa-upload"></i> 2- {{__('messages.upload_photo')}}</button>
                                        </form>
                                    </div>
...
// add subtask
        ...
        $("#add_comment").on('click', function () {
            ...
            $.ajax({
                ...
                data: {comment: comment,subtask_id : subtask_id ,  tags: tagstring, task_id: task_id, _token: '{{ csrf_token() }}'},
                cache: false,
                success: function (data) {
                    var type = '1';
                    $.ajax({
        ...
        $('.send_replay').each(function() {
            $(this).on('click' , function (){
                ...
                $.ajax({
                    url: '{{route('admin.subtasks.store_replay')}}',
                    method: "POST",
                    data: {tags:tagstring , addedby : addedby ,comment_id : comment_id ,replay_comment : replay_formattedValue , task_id:task_id , comment_author :comment_author ,   _token: '{{ csrf_token() }}'},
                    success: function (data) {
