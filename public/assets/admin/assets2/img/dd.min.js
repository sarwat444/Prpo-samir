    ...
    class t {
        ...
        _createByJson() {
            if (this._settings.byJson.data) try {
                let e = this._settings.byJson, t = {};
                t.name = e.name || this.ele.id || "", e.size > 0 && (t.size = e.size), e.multiple && (t.multiple = e.multiple);
                let s = this._createEle("select", t), i = e.data.length;
                for (let t = 0; t < i; t++) {
                    let i = e.data[t], l = new Option(i.text, i.value);
                    i.disabled && (l.disabled = !0);
                    for (let e in i) if (i.hasOwnProperty(e) && "text" !== e.toLowerCase()) {
                        let t = `data-${e}`;
        ...
        _applyFilters(e) {
            ...
            if (0 === t.length) this._show(this._wrapper.headerA), this._makeChildren(), this._isFilterApplied = !1; else {
        ...
        _makeFilterBox() {
            let e = this._createEle("div", {className: "ms-filter-box"}), t = this._createEle("input", {type: "text"});
        ...
        _makeHeader() {
            let e = this._css, t = this._createEle("div", {className: e.header}),
        ...
        _makeChildren(e = null) {
            let t, s = this._css, i = "true" === this._enableCheckbox.toString(), l = this, n = function (e, t) {
                let n = {};
                ...
                t.isDisabled || (l._bindEvents(e, "mouseup", (e => {
                    ...
                    if (l._isMouseDown = !0, i && "INPUT" === t.target.nodeName) l._setSelectedByItemToggle(e._refCheckbox, e); else if (l._shiftHolded && l._isMultiple) {
                        let t = l.selectedIndex, s = e.index;
            ...
            let a = null === e ? this.ele.children : e, h = a.length;
            for (let e = 0; e < h; e++) {
                let i = a[e], l = n(i, e), h = l.opt, d = l.itemObj, o = this._createRow(d);
                if ("" !== h.className && (o.className = o.className + " " + h.className), "" !== h.internalStyle && (o.style = h.internalStyle), o.index = h.index, o.setAttribute("data-ms-index", h.index), d.isOptGroup) {
                    let e = i.children, t = e.length, l = this._createEle("ul");
                    for (let i = 0; i < t; i++) {
                        let t = n(e[i], i), a = t.opt, h = t.itemObj, d = this._createRow(h);
        ...
        _makeLayout() {
            this.ele.tabIndex = -1;
            let t = this._css, s = this._createEle("div", {tabIndex: 0, className: t.dd}), i = this.ele.name,
                l = this.ele.required, n = this._createEle("input", {
                    tabIndex: -1,
                    name: i,
                    type: "text",
            ...
            let a = this._makeHeader(), h = this._makeFilterBox();
        ...
        _createRow(e) {
            let t = e.isOptGroup ? this._css.optgroup : this._css.item, s = this._createEle("li", {className: t});
        ...
        _parseOption(e) {
            let t, s, i, l = null, n = "", r = "", a = "", h = "", d = "", o = "", u = -1;
            if (void 0 !== e) {
                let _ = e.nodeName, p = e.dataset;
        ...
        _setSelectedByItem(e, t = !1, s = !0) {
            if (t && e) e.classList.add(this._css.itemSelected); else {
                let t = e.index;
        ...
        _setSelectedByOptionItem(e, t = !1) {
            let s = e.index, i = this._getDataAndUI(s);
            this._setSelectedByItem(i.ui, t)
        }

        _updateHeaderUI(e = null, t = null) {
            let s = null === e ? this.uiData : e, i = this._isArray(s.index) ? s.ui[0].innerHTML : null;
        ...
        _findElementByIndexProp(e) {
            let t = this._getAllEle(`ul li.${this._css.item}`, this._wrapper.holder), s = t.length;
            for (let i = 0; i < s; i++) if (t[i].index === e) return t[i];
            return null
        }

        _getDataAndUI(e = null) {
            let t, s, i, l = this.ele, n = null, r = -1, a = this, h = !1, d = function (e) {
                let t = l.options[e], s = e;
                return {option: t, data: a._parseOption(t), index: s, ui: a._findElementByIndexProp(s)}
            };
            if (null !== e) i = d(e), n = i.option, t = i.data, r = i.index, s = i.ui; else if (s = this._getAllEle("ul li." + this._css.itemSelected, this._wrapper.holder), s.length > 1) {
                let e = [], l = [], a = [], o = [];
...
*/
        ...
        _getProp(e, t) {
            ...
            for (let i = 0; i < e.attributes.length; i++) {
                let l = e.attributes[i].nodeName, n = e.attributes[i].nodeValue;
                if (t === l) return n;
                s[l] = n
            }
        ...
        _setTitleMinHeight(e = !0) {
            let t = 0;
            if (!0 === e) {
                let e = this._getAllEle("li", this._wrapper.listOfItems), s = e.length;
                for (let i = 0; i < s; i++) {
                    let s = e[i];
        ...
        _bindDocumentEvents(e, t = !0, s = !0) {
            this._unbindDocumentEvents(), this._onDocumentClick = e => {
                let t = this._wrapper.listOfItems.getBoundingClientRect(),
                    s = this._wrapper.header.getBoundingClientRect(), i = t.left + t.width,
        ...
        _scrollToIfNeeded(e = null, t = null, s = "next") {
            ...
            if (i.getBoundingClientRect(), null === e && null !== t && (i.scrollTop = t), e = void 0 !== e ? e : this._getEle("li." + this._css.itemSelected)) {
                let t = e.offsetTop, l = i.clientHeight, n = e.clientHeight;
        ...
        _fireLocalEventIfExist(e, t = null) {
            if ("function" == typeof this._settings.on[e]) {
                let s = null === t ? this._getDataAndUI() : t, i = this._settings.on[e];
                try {
                    i(s)
                } catch (e) {
        ...
        next() {
            let e, t = this, s = this.optionsUI, i = s.length;
        ...
        namedItem(e, t = !1) {
            let s = null, i = this.ele.querySelector(`option[name='${e}']`);
            if (i && t) {
                s = {};
        ...
        item(e, t = !1) {
            let s = null, i = this.ele.options[e];
            if (i && t) {
                s = {};
                let e = this._parseOption(i);
                s.option = i, s.data = e
    ...
    customElements.define("ms-dropdown", i, {extends: "select"}), window.MsDropdown = s, navigator.vendor && navigator.vendor.indexOf("Apple") > -1 && navigator.userAgent && -1 == navigator.userAgent.indexOf("CriOS") && -1 == navigator.userAgent.indexOf("FxiOS") && s.make("select[is='ms-dropdown']")
})();