...
<table id="filterd_table" class="table table-bordered filtered_table" cellspacing="0" width="100%" data-orderable="3" data-orderable_type="desc">
    <thead>
    <tr>
    ...
    @foreach($notes as $note)
                <tr>
                        ...
                        @if(!empty($note->readby) && in_array(auth::user()->id , $readed ))
                    ...
                    <td>
                        ...
                        <p class="addedby_id" style="height: 0px">{{$note->id}}} </p>
