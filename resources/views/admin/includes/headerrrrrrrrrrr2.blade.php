            ...
            <ul class="navbar-nav navbar-light nav-bar">
              ...
              @auth
                   ...
                   <li class="nav-item">
                     ...
                     <div class="notfi-icon" id="notfi-bell"> <img src="https://i.imgur.com/AC7dgLA.png" alt=""> </div>
                     <div class="notfi-notifications" id="notfi-box">


                <a href="{{route('admin.get.all_logs')}}"> View All Notifications </a> 
        @php
         ...
         @foreach($logs as $log )
          ...
          @if((!in_array(Auth::user()->id , $arr)))
           ...
           @if(!empty($log->log_task_id))
            ...
            @if(!empty($log->log_task_id) || !empty($log->log_subtask_id))
          ...
          @endif
                ...
                @if($status == 1)
                 <li class="nav-item">
                  <a class="nav-link" href="{{route('admin.dashboard','completed')}}"   role="button" aria-expanded="false">
                     <i class="bi bi-check-square" style="color:green;font-size:28px;"></i>
                  </a>
                ...
                @endif
                  ...
                  <a class="nav-link" href="{{route('admin.dashboard')}}"   role="button" aria-expanded="false">
                     <i class="bi bi-check-square" style="color:#fff;font-size:25px;"></i>
                  </a>
               ...
               <li class="nav-item">
                  <a class="nav-link" href="{{route('admin.dashboard')}}"   role="button" aria-expanded="false">
                     <i class="bi bi-check-square" style="color:#fff;font-size:20px;"></i>
                  </a>
                ...
                <div class="btn-group float-end">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                         ...
                         @if(Auth::user()->role == 1)
                          <li><a class="dropdown-item" data-type="user_create"  href="{{route('admin.categories')}}"><i class="bi bi-pencil-square"></i> Task editiern</a></li>
                        ...
                        <li><a href="{{route('admin.usertasks')}}" class="dropdown-item"><i class="bi bi-box-arrow-right"></i>  Meine Aufgaben  </a></li>
                          <li><a href="{{route('admin.logout')}}" class="dropdown-item"><i class="bi bi-box-arrow-right"></i>  Ausloggen  </a></li>
                    </ul>
                </div>
  ...
  <div class="main-container" id="container">
     ...
     <div class="modal-dialog" role="document">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Refresh Login </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         <p> Are You Exist Now ? </p>
      </div>
      <div class="modal-footer">

        <button type="button" class="btn btn-primary" id="popup_button">Yes</button>
      </div>
    </div>
  </div>
</div>
