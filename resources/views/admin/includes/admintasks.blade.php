                            ...
                            <div class="col-md-2">
                                 <div class="form-control all">
                                     <label class="form-checkbox-label">
                                        <input name="completed" class="form-checkbox-field" type="checkbox" name="all" id="all" data-type="all" value="all"  /> <label>Alle</label>
                             ...
                             <div class="form-control">
                                    <select  name="users" id="subtasks_users" is="ms-dropdown" data-type="user_filter"  required>
						   ...
						   <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                 <div class="form-control status">
                                        ...
                                        <input type="radio" name="subtask_status" value='0'  data-type="status_filter"/> <label>Offen</label>
                                </div>
                            </div>
                    </div>
               </form>
