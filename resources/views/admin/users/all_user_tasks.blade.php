                                    ...
                                    @foreach($users as $user)
                                        <div class="swiper-slide cat_list">
                                            <a href="{{route('admin.user.tasks',['user_id' => $user->id ,'status' => $status ])}}">
                                                <div @if($user->id == $user_id ) class="category-button  filter active"
                                                     @else class="category-button  filter" @endif data-type="user"
                ...
                <div class="category_sidebar">
                    <ul>
                        <a href="{{route('admin.cat.tasks',['cat_id' => 0 ,'status' => $status ])}}">
                            <li class="category-button  filter" data-status="{{$status}}"> Alle</li>
                        </a>
                        @if(!empty($categories))
                                            ...
                                            <div class="button-bar">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        @endif
                                                        <button class="btn btn-default copy" data-id="{{$task->id}}"><i
