    ...
    <div id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
        <form id="edit_subtask" action="{{route('admin.tasks.update',$task->id)}}" method="POST"
            ...
            <div class="position-sticky">
                ...
                <div class="main-tasks" style="overflow: hidden">
                    ...
                    <div class="subtasks-header">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="completed_count">{{$task->completed_subtasks->count()}} </div>
                            </div>
                            <div class="col-md-1">
                            ...
                            @foreach($task->comments as $comment)
                                <div class="col-md-9">
                                    <div class="comment" id="com_dta{{$comment->id}}">
                                        <div class="row">
                                            <div class="col-md-1">
                                                <img class="comment_maker" src="{{asset('public/assets/images/users/'.$comment->user->image)}}"
                                                     alt="test" />
                                            </div>
                                            <div class="col-md-11">
                                                ...
                                                @if(!empty($comment->comment))
                                                    <p contenteditable="false" id="comment_name{{$comment->id}}"
                                                      ...
                                                      <a href="#" class="btn btn-success" class="commentt_name{{$comment->id}}"> Update Comment </a>
                                                    @php
