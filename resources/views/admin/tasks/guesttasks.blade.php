                  ...
                  <div class="col-md-1">
                               ...
                               <div class="col-md-3">
                                    <div class="form-control status">
                                           <input type="radio" name="subtask_status" value='1'  data-type="status_filter" data-gender="list"/> <label>{{__('messages.Erledigt')}} </label>
                               ...
                               <div class="col-md-5">
                                    <div class="form-control status">
                                           <input type="radio" name="subtask_status2" value='3'  data-type="status2_filter" data-gender="list"/> <label> {{__('messages.Erstellt_am')}}   </label>
                                           <input type="radio" name="subtask_status2" value='4'  data-type="status2_filter" data-gender="list"/> <label>    {{__('messages.Falligkeitsdatum')}}  </label>
                                           <input type="radio" name="subtask_status2" value='5'  data-type="status2_filter" data-gender="list"/> <label>{{__('messages.Erledigt')}} </label>
                                   </div>
                               </div>
                       </div>
                  </form>
     ...
     $("#all").on('click',function (event) {
            ...
            // alert(type);
              $.ajax({
                      ...
                      type: "POST",
                      url:   '{{route('admin.filter.guesttasks')}}',   // need to create this post route
