    ...
    <div id="basic" class="col-lg-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <form class="text-left" id="add_user" action="{{route('admin.guest.store')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    <div id="username-field" class="field-wrapper input form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <label>Guest {{__('messages.Vorname')}}</label>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div id="username-field" class="field-wrapper input form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <label>{{__('messages.Nachname')}} </label>
                            </div>
                            <div class="col-md-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input id="user_name" name="user_name" type="text" class="form-control"
                                       placeholder="{{__('messages.Username')}}" autocomplete="off">
                ...
                <i class="fa fa-eye" id="togglePasswordIcon-password_confirmation"></i>
                    ...
                    <div id="password-field" class="field-wrapper input mb-2 form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <label>  {{__('messages.Foto_hochladen')}}  </label>
                            </div>
                            <div class="col-md-7">
