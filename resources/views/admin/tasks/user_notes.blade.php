                                  ...
                                  <div class="row" style="padding-left: 10px;">
                                          ...
                                          <div class="col-md-2">
                                              <div class="form-control status">
                                                  <input id="erledigt" type="checkbox" name="erledigt" value='1' data-type="erledigt_filter" /> <label> {{__('messages.Erledigt')}}</label>
                                              </div>
                                          </div>

                                          <div class="col-md-2">
                                              <div class="form-control status">
                                                  <input class="show_read_comments" name="seen" type="checkbox"  value='1' /> <label> Seen </label>
                                              </div>
                                          </div>
...
*/
        ...
        $('.search-btn').on('click', function () {
            ...
            {
                $.ajax({
                    url: '{{route('admin.comments.show_read_comments')}}',
                    type: "POST",
                    // need to create this post route
                    data: {
