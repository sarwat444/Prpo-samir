                          ...
                          @if(!empty($tags))
                              @foreach($tags as $tag)
                                    <div class="swiper-slide cat_list" style="margin-right:5px;">
                                      <a href="{{route('admin.cat.tag.tasks',['cat_id' => $cat_id ,'tag_id' => $tag->id ,'status' => $status ])}}">     <div class="category-button  filter">
                                                 ...
                                                 <div class="col-md-6">
                                                  ...
                                                  @endif
                                                   <span> {{--!empty($task->added_by->user_name) ? $task->added_by->user_name :' ' --}} </span>
                                                      <button class="btn btn-default copy" data-id="{{$task->id}}" ><i class="bi bi-clipboard-plus"></i></button>
                                                 </div>
                                                 <div class="col-md-6">
