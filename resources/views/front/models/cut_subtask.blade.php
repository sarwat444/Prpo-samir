<div class="form-group">
    <p>möchtest Du <b>{{$subtask->subtask_title}}</b> Verschieben?</p>
    <form method="POST" action="{{route('subtask.cut',['id'=>$subtask->id])}}">
        @csrf
    ...
    <select name="task" class="form-control cut_select" >
